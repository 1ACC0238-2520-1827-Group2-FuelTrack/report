...
<table border="1">
  ...
  <tbody>
    ...
    <tr>
      ...
      Entonces el sistema deberá generar un token JWT para acceso a recursos protegidos.</td>
      ...
      Cuando se procesa el POST<br>
      Entonces el sistema retorna 401 (o 403 si está bloqueada) sin emitir tokens</td>
      <td>EP03</td>
    </tr>
    <tr>
      <td>TS03</td>
